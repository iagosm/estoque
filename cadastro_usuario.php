...
<div class="form-group">
    ...
    <select name="nivelusuario" id="" class="form-control form-select" >
            <option value="1">Administrador</option><!-- Acesso completo -->
            <option value="2">Funcionário</option><!-- Apenas adicionar produto -->
            <option value="3">Conferente</option><!-- Apenas visualizar -->
            <option value="4">Estagiário</option><!-- Apenas visualizar -->
            </select>
</div>
